...
namespace FileManager.ViewModels.Information
{
    public class InformationControlViewModel : BindableBase
    {
        ...
        {
            batteryResourceLoader = ResourceLoader.GetForCurrentView(string.Join('\\', Constants.Resources, Constants.Batteries));
            stringsResourceLoader = ResourceLoader.GetForCurrentView(Constants.StringResources);
            themeResourceLoader = ResourceLoader.GetForCurrentView(string.Join('\\', Constants.Resources, Constants.ImagesLight));
        }
